...
Written:        2022-03-24
Updated:        2022-04-17 (JL)
                2022-04-25 (JW)

"""
import camstim
from psychopy import monitors, visual
from camstim import SweepStim, Stimulus, Foraging, Window, Warp
...
if __name__ == "__main__":
    ...
    SESSION_PARAMS  = { 'subject_id':                   'test',                     # subject identifier information
                        ...
                        'cohort':                       1,#cohort,                     # which orientation cohort (1, 2)
                        'habituation_duration':         60 * 2.10, #habituation_time_min,  # desired habituation block duration (sec)
                        ...
                        'stimulus_drift_rate':          4.0,#stimulus_drift_rate,        # stimulus drift rate (0 for static)
