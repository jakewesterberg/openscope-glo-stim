...
SESSION_PARAMS  = { 'subject_id':                   'test',                 # subject identifier information
                    ...
                    'glo_duration':                 60 * 1,                 # desired GLO block duration (sec)
                    'randomized_control_duration':  60 * 1,                 # desired radomized control block duration (sec)
                    'sequenced_control_duration':   60 * 1,                 # desired sequenced control block duration (sec)
