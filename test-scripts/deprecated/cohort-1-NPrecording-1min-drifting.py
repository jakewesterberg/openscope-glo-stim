...
SESSION_PARAMS  = { 'subject_id':                   'test',                 # subject identifier information
                    ...
                    'habituation_duration':         60 * .25,               # desired habituation block duration (sec)
                    'glo_duration':                 60 * .75,              # desired GLO block duration (sec)
                    'control_duration':             60 * .5,              # desired control block duration (sec)
                    'pre_blank':                    1.0,                   # blank before stim starts (sec)
                    'post_blank':                   1.0,                   # blank after all stims end (sec)
