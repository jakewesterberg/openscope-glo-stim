...
SESSION_PARAMS  = { 'subject_id':                   'test',                 # subject identifier information
                    ...
                    'habituation_duration':         60 * 0.4,               # desired habituation block duration (sec)
                    'glo_duration':                 60 * 8.0,               # desired GLO block duration (sec)
                    'randomized_control_duration':  60 * 2.0,              # desired radomized control block duration (sec)
                    'sequenced_control_duration':   60 * 0.8,              # desired sequenced control block duration (sec)
